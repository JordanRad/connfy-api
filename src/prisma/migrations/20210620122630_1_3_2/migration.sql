...
INSERT INTO "new_Meeting" ("channelId", "createdAt", "date", "description", "endTime", "id", "startTime", "users") SELECT "channelId", "createdAt", "date", "description", "endTime", "id", "startTime", "users" FROM "Meeting";
DROP TABLE "Meeting";
